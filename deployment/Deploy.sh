...
git clone https://github.com/arturmedeiros/docker-laravel.git
echo "✅  Etapa concluída!"

## Permissão na pasta
echo "🔒 Concedendo permissões..."
chmod +x docker-laravel
sudo chmod 777 -R docker-laravel/backend/
echo "✅  Etapa concluída!"
...
# Automático
# curl -s "https://raw.githubusercontent.com/arturmedeiros/docker-laravel/master/deployment/Deploy.sh" | bash

# Personalizado
# bash <(curl -s "https://raw.githubusercontent.com/arturmedeiros/docker-laravel/master/deployment/Deploy.sh")
